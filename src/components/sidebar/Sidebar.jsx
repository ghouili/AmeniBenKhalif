  ...
  return (
    <div className='sidebar fixed z-20 h-screen p-3 flex flex-col gap-4  border transform transition-all duration-500 bg-white '>
     ...
     <Link to='#clients'>
      ...
      >
        <FiUsers size={24} />
        <span className={`font-semibold ${sidebarOpen ? '': 'hidden' }`}>Manage clients</span>
      </div>
      </Link>
     ...
     <Link to='#agents'>
      ...
      >
        ...
        <span className={`font-semibold ${sidebarOpen ? '': 'hidden' }`}>Manage Agents</span>
      </div>
      </Link>
     ...
     <Link to='#bills'>
      ...
      >
        ...
        <span className={`font-semibold ${sidebarOpen ? '': 'hidden' }`}>Bills</span>
      </div>
      </Link>
     ...
     <Link to='#settings'>
      ...
      >
        <RxGear size={24} />
        <span className={`font-semibold ${sidebarOpen ? '': 'hidden' }`}>Settings</span>
      </div>
      </Link>
     ...
     <Link to='#BHour'>
      ...
      >
        ...
        <span className={`font-semibold ${sidebarOpen ? '': 'hidden' }`}>Business hour</span>
      </div>
      </Link>
     ...
     <Link to='#CSupport'>
      ...
      >
        ...
        <span className={`font-semibold ${sidebarOpen ? '': 'hidden' }`}>Contact support</span>
      </div>
      </Link>
